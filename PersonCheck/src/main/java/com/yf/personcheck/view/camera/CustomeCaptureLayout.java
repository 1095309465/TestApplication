...
public class CustomeCaptureLayout extends FrameLayout {

    private CaptureListener captureLisenter;    //拍照按钮监听
    private CustomeListener customeListener;    //拍照按钮监听
    ...
    public void setCustomeLisenter(CustomeListener customeListener) {
    ...
    private CustomeCaptureButton btn_capture;      //拍照按钮
    ...
    public CustomeCaptureLayout(Context context) {
        this(context, null);
    }

    public CustomeCaptureLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomeCaptureLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        ...
        //拍照按钮
        btn_capture = new CustomeCaptureButton(getContext(), button_size);
