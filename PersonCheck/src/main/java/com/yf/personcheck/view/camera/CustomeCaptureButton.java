...
public class CustomeCaptureButton extends View {
    ...
    private CustomeCaptureButton.LongPressRunnable longPressRunnable;    //长按后处理的逻辑Runnable
    private CaptureListener captureLisenter;        //按钮回调接口
    private CustomeListener customeListener;        //按钮回调接口
    private CustomeCaptureButton.RecordCountDownTimer timer;             //计时器

    public CustomeCaptureButton(Context context) {
        super(context);
    }

    public CustomeCaptureButton(Context context, int size) {
        super(context);
        ...
        progress = 0;
        longPressRunnable = new CustomeCaptureButton.LongPressRunnable();
        ...
        timer = new CustomeCaptureButton.RecordCountDownTimer(duration, duration / 360);    //录制定时器
    }
